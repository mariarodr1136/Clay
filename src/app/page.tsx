...
import { ArrowRight, Database, History, MessageSquareText, Sparkles } from "lucide-react";
...
export default async function Home() {
  ...
  return (
    <div className="relative flex flex-1 flex-col overflow-hidden">
      ...
      <section className="mx-auto flex w-full max-w-3xl flex-col items-center justify-center gap-7 px-6 pt-14 pb-20 text-center sm:pt-20">
        ...
        <h1
          className={`${fraunces.className} text-5xl leading-[1.05] font-medium tracking-tight text-balance sm:text-7xl`}
        >
          Ask your interface
          <br />
          <span className="text-primary">into existence.</span>
        </h1>
      ...
      <section className="mx-auto w-full max-w-4xl px-6 pb-24 sm:pb-32">
        <div className="rounded-2xl border border-black/[0.08] bg-card p-3 shadow-sm sm:p-4 dark:border-white/[0.08]">
          <div className="grid gap-3 rounded-xl bg-muted/50 p-4 sm:grid-cols-3 sm:p-6">
      ...
      <section className="mx-auto w-full max-w-5xl border-t border-black/[0.08] px-6 py-20 sm:py-28 dark:border-white/[0.08]">
        ...
        <div className="grid items-center gap-10 sm:grid-cols-2 sm:gap-16">
          ...
          <div className="order-1 sm:order-2">
            <div className="rounded-xl border border-black/[0.08] bg-card p-3 shadow-sm dark:border-white/[0.08]">
              <div className="grid gap-2.5 rounded-lg bg-muted/50 p-3">
                {[
      ...
      <section className="mx-auto w-full max-w-5xl border-t border-black/[0.08] px-6 py-20 sm:py-28 dark:border-white/[0.08]">
        ...
        <div className="grid items-center gap-10 sm:grid-cols-2 sm:gap-16">
          ...
          <div>
            <div className="space-y-2.5 rounded-xl border border-black/[0.08] bg-card p-3 shadow-sm dark:border-white/[0.08]">
      ...
      <section className="mx-auto w-full max-w-5xl border-t border-black/[0.08] px-6 py-20 sm:py-28 dark:border-white/[0.08]">
        ...
        <div className="grid items-center gap-10 sm:grid-cols-2 sm:gap-16">
          ...
          <div className="order-1 sm:order-2">
            <div className="space-y-2 rounded-xl border border-black/[0.08] bg-card p-3 shadow-sm dark:border-white/[0.08]">
              {[
