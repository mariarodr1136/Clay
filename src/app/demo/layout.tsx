    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 px-6 py-8 sm:px-8 sm:py-10">
        <div className="mx-auto max-w-6xl space-y-8">
          <div className="print-hidden flex flex-col items-start justify-between gap-3 rounded-2xl border border-dashed border-border bg-muted/40 px-5 py-3.5 sm:flex-row sm:items-center">
