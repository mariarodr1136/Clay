...
export const sampleProjects: SampleProject[] = [
  {
    ...
    tasks: [
      ...
      { title: "Design new pricing page", description: "Three-tier layout, monthly/annual toggle.", status: "in_review", priority: "high", points: 5, owner: 2, dueInDays: -1, openedDaysAgo: 9 },
      { title: "Migrate blog to new CMS", status: "in_progress", priority: "medium", points: 8, owner: 1, dueInDays: 4, openedDaysAgo: 16 },
      { title: "Fix broken redirects from old URLs", status: "todo", priority: "urgent", points: 2, owner: 0, dueInDays: -3, openedDaysAgo: 22 },
      { title: "QA pass on mobile breakpoints", description: "iOS Safari and Android Chrome at minimum.", status: "todo", priority: "high", points: 3, owner: 4, dueInDays: 6, openedDaysAgo: 5 },
  ...
  },
  {
    ...
    tasks: [
      ...
      { title: "Conflict resolution for offline edits", description: "Last-write-wins is not going to survive contact with users.", status: "in_progress", priority: "urgent", points: 13, owner: 3, dueInDays: 8, openedDaysAgo: 24 },
      { title: "Crash-free rate back above 99.5%", status: "in_progress", priority: "urgent", points: 5, owner: 1, dueInDays: -2, openedDaysAgo: 31 },
      { title: "Rework onboarding carousel", status: "in_review", priority: "medium", points: 5, owner: 2, dueInDays: 3, openedDaysAgo: 12 },
      { title: "Drop support for iOS 15", status: "todo", priority: "low", points: 3, owner: 4, dueInDays: 20, openedDaysAgo: 4 },
      { title: "Instrument sync failures", status: "todo", priority: "high", points: 3, dueInDays: -5, openedDaysAgo: 27 },
  ...
  },
  {
    ...
    tasks: [
      ...
      { title: "Migrate active subscriptions", description: "Batched, reversible, with a dry run first.", status: "in_progress", priority: "urgent", points: 13, owner: 1, dueInDays: 5, openedDaysAgo: 19 },
      { title: "Dunning emails on the new provider", status: "in_review", priority: "high", points: 5, owner: 4, dueInDays: 1, openedDaysAgo: 8 },
      { title: "Decommission the legacy webhook", status: "todo", priority: "medium", points: 3, owner: 0, dueInDays: 25, openedDaysAgo: 3 },
      { title: "Finance sign-off on the first cycle", status: "todo", priority: "high", points: 2, dueInDays: -8, openedDaysAgo: 40 },
    ],
  },
  {
    ...
    tasks: [
      ...
      { title: "In-app checklist widget", status: "in_progress", priority: "medium", points: 8, owner: 2, dueInDays: 9, openedDaysAgo: 13 },
  ...
  },
  {
    ...
    tasks: [
      ...
      { title: "Agree company-wide metric definitions", description: "Two teams currently disagree on what 'active' means.", status: "in_review", priority: "high", points: 5, owner: 0, dueInDays: 2, openedDaysAgo: 21 },
      { title: "Nightly freshness alerts", status: "in_progress", priority: "medium", points: 5, owner: 3, dueInDays: 11, openedDaysAgo: 7 },
      { title: "Deprecate the old reporting sheet", status: "todo", priority: "low", points: 2, owner: 4, dueInDays: 30, openedDaysAgo: 2 },
      { title: "Row-level access for customer data", status: "todo", priority: "urgent", points: 8, dueInDays: -4, openedDaysAgo: 35 },
    ],
  },
  {
    name: "Design System",
    ...
    tasks: [
      ...
      { title: "Dark mode audit", status: "in_progress", priority: "medium", points: 5, owner: 2, dueInDays: 7, openedDaysAgo: 10 },
      { title: "Accessibility pass on form controls", description: "Keyboard paths and focus order, not just contrast.", status: "in_progress", priority: "high", points: 8, owner: 4, dueInDays: -6, openedDaysAgo: 29 },
      { title: "Publish the component docs site", status: "todo", priority: "medium", points: 5, owner: 2, dueInDays: 16, openedDaysAgo: 4 },
